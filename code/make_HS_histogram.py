...
# force the band we want to be an integer, and convert to python index
...
if(DEBUG): f.visititems(ls_dataset)
...
if(DEBUG): print('SERC Reflectance Data Dimensions:',refl_shape)
...
if(DEBUG): print('b' + str(band_of_interest + 1) + ' type:', type(my_band))
if(DEBUG): print('b' + str(band_of_interest + 1) + ' shape:', my_band.shape)
if(DEBUG): print('Band ' + str(band_of_interest + 1) + ' Reflectance:\n', my_band)
# plt.hist(my_band.flatten())
...
plt.title('Histogram of SERC Band ' + str(band_of_interest + 1) +' Reflectance')
